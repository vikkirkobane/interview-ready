          ...
          <View style={styles.list}>
            {recentActivities.map((activity, i) => {
              const handlePress = () => {
                ...
                else if (activity.type === 'job_match') router.push(`/(tabs)/job-match-results?id=${activity.id}`);
                else if (activity.type === 'interview') router.push(`/(tabs)/feedback?id=${activity.id}`);
              };

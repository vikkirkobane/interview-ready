...
const aiResume = (templateId: string | null): DraftResume => ({
  ...
  education: [
    ...
    { id: '2', degree: 'B.S. in Computer Science', institution: 'UC Berkeley', year: '2012 – 2016', note: 'Honors Graduate' },
  ],
  certifications: [
    { id: '1', name: 'Certified Scrum Product Owner (CSPO)', issuer: 'Scrum Alliance', year: '2022' },
  ],
  awards: [],
  featuredProject: {
    include: true,

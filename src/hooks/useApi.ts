...
export const useResumeQuery = (resumeId: string | null) => {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const mappedContent = {
        templateId: content.templateId || content.template_id || data.template_id || 'executive',
        meta: {
          candidate_name: content.header?.name || content.contact?.name || content.name || '',
          profession: content.header?.title || content.contact?.title || content.title || data.title || '',
        ...
        header: {
          name: content.header?.name || content.contact?.name || content.name || '',
          title: content.header?.title || content.contact?.title || content.title || data.title || '',
          subtitle: content.header?.subtitle || content.contact?.subtitle || '',
          location: content.header?.location || content.contact?.location || '',
          email: content.header?.email || content.contact?.email || '',
          phone: content.header?.phone || content.contact?.phone || '',
          linkedin: content.header?.linkedin || content.contact?.linkedin || '',
          portfolio: content.header?.portfolio || content.contact?.portfolio || '',
        },

...
export default function TermsOfServiceModal({ isOpen, onClose }: TermsOfServiceModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs z-100 flex items-center justify-center p-4 animate-fade-in">
      <div 
        className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[85vh] flex flex-col relative overflow-hidden border border-gray-100 animate-slide-up"
        role="dialog"
        aria-modal="true"
      >
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-slate-50">
          <div>
            <h2 className="text-xl font-bold font-display text-slate-900">Terms and Conditions</h2>
            <p className="text-xs text-slate-500 mt-0.5">Last updated: July 19, 2026</p>
          </div>
          <button 
            onClick={onClose}
        ...
        {/* Scrollable Content */}
        <div className="overflow-y-auto p-6 md:p-8 space-y-6 text-sm leading-relaxed text-slate-600">
          ...
          <div className="prose prose-slate max-w-none space-y-6">
            ...
            <section className="border-t border-gray-100 pt-6">
              ...
              <ul className="list-disc pl-5 space-y-2.5">
                <li>
                  <strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named <span className="font-semibold text-slate-800">Interview Ready</span>.
                </li>
                <li>
                ...
                <li>
                  <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to <span className="font-semibold text-slate-800">Interview Ready</span>.
                </li>
                <li>
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">Acknowledgment</h2>
              <p className="mb-3">
            ...
            <section className="border-t border-gray-100 pt-6">
              ...
              <h3 className="text-base font-bold text-slate-800 font-display mt-4 mb-2">Links from a Third-Party Social Media Service</h3>
              <p className="mb-3">
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">Termination</h2>
              <p className="mb-3">
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">Limitation of Liability</h2>
              <p className="mb-3">
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
              <p className="mb-3 font-mono text-xs bg-slate-50 p-4 rounded-xl border border-gray-100 text-slate-700 leading-relaxed">
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">Governing Law</h2>
              <p className="mb-3">
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">Disputes Resolution</h2>
              <p className="mb-3">
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">For European Union (EU) Users</h2>
              <p className="mb-3">
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">United States Legal Compliance</h2>
              <p className="mb-3">
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">Severability and Waiver</h2>
              <h3 className="text-base font-bold text-slate-800 font-display mt-4 mb-2">Severability</h3>
              <p className="mb-3">
                If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
              </p>
              
              <h3 className="text-base font-bold text-slate-800 font-display mt-4 mb-2">Waiver</h3>
              <p className="mb-3">
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">Translation Interpretation</h2>
              <p className="mb-3">
            ...
            <section className="border-t border-gray-100 pt-6">
              <h2 className="text-lg font-bold text-slate-900 font-display mb-3">Changes to These Terms and Conditions</h2>
              <p className="mb-3">
        ...
        {/* Footer actions */}
        <div className="flex items-center justify-end px-6 py-4 border-t border-gray-100 bg-slate-50 gap-3">
          <button 
            onClick={onClose}
            className="px-5 py-2 text-sm font-semibold rounded-xl bg-[#1A4F8A] hover:bg-[#153e6d] text-white transition-all duration-200 shadow-sm focus:outline-none"
          >
            Accept & Close
          </button>
        </div>

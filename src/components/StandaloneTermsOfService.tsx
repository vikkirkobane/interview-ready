...
interface StandaloneTermsOfServiceProps {
  onBack?: () => void;
}

export default function StandaloneTermsOfService({ onBack }: StandaloneTermsOfServiceProps) {
      ...
      <main className="flex-grow py-8 px-4 md:py-12">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6 md:p-10">
          <div className="mb-8 border-b border-slate-100 pb-6">
            <h1 className="text-2xl md:text-3xl font-extrabold font-display text-slate-900">Terms and Conditions</h1>
